//! Vue pour l'étape initiale de l'inscription.
    ...
    format!(
        ...
        <div style="padding: 40px;">
            ...
            <div style="display: grid; gap: 16px; margin-bottom: 32px;">
                ...
                <a href="/auth/google" class="button button-secondary full-width"
                        style="min-height: 52px; font-size: 1rem; display: flex; align-items: center; justify-content: center; gap: 12px; border: 1px solid #DDD; background: white; color: #333; text-decoration: none;">
